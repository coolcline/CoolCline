...
/**
 * Combines API request start and finish messages in an array of CoolClineMessages.
 *
 ...
 * @returns A new array of CoolClineMessage objects with API requests combined.
 *
 * @example
 * const messages = [
...
export function combineApiRequests(
  ...
  const combinedApiRequests: CoolClineMessage[] = [];
