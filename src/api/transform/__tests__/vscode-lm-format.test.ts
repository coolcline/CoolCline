...
describe('vscode-lm-format', () => {
  describe('convertToVsCodeLmMessages', () => {
    ...
    it('should handle image blocks with appropriate placeholders', () => {
      ...
      expect(result).toHaveLength(1);
      const imagePlaceholder = result[0]
        .content[1] as MockLanguageModelTextPart;
  ...
  describe('convertToAnthropicMessage', () => {
    ...
    it('should convert assistant message with tool calls', async () => {
      const vsCodeMessage = {
        ...
        name: 'assistant',
        content: [
          new vscode.LanguageModelToolCallPart('call-1', 'calculator', {
            operation: 'add',
            numbers: [2, 2],
          }),
        ],
    ...
    it('should throw error for non-assistant messages', async () => {
      ...
      await expect(
        convertToAnthropicMessage(vsCodeMessage as any)
      ).rejects.toThrow(
