          ...
          <>
            <div style={headerStyle}>
              ...
              <span style={{ fontWeight: 'bold' }}>
                CoolCline wants to edit this file:
              </span>
            </div>
            <CodeAccordian
        ...
        return (
          <>
            <div style={headerStyle}>
              {toolIcon('new-file')}
              <span style={{ fontWeight: 'bold' }}>
                CoolCline wants to create a new file:
              </span>
            </div>
            <CodeAccordian
              isLoading={message.partial}
          ...
          <>
            <div style={headerStyle}>
              ...
              <span style={{ fontWeight: 'bold' }}>
                {message.type === 'ask' ? (
                  <>
                    CoolCline wants to search this directory for{' '}
                    <code>{tool.regex}</code>:
                  </>
                ) : (
                  <>
                    CoolCline searched this directory for{' '}
                    <code>{tool.regex}</code>:
                  </>
                )}
              </span>
...
const Markdown = memo(
  ({ markdown, partial }: { markdown?: string; partial?: boolean }) => {
