...
const AutoApproveMenu = ({ style }: AutoApproveMenuProps) => {
  ...
  const actions: AutoApproveAction[] = [
    ...
    },
    {
      ...
      description:
        'Automatically retry failed API requests when the provider returns an error response.',
    },
  ];
    ...
    >
      ...
      {isExpanded && (
        <div style={{ padding: '0' }}>
          ...
          >
            Auto-approve allows CoolCline to perform actions without asking for
