  ...
  const handleSubmit = () => {
    ...
    if (!apiValidationResult && !modelIdValidationResult) {
      ...
      vscode.postMessage({
        ...
        bool: alwaysAllowReadOnly,
      });
      vscode.postMessage({ type: 'alwaysAllowWrite', bool: alwaysAllowWrite });
      vscode.postMessage({
        type: 'alwaysAllowExecute',
        bool: alwaysAllowExecute,
      });
      vscode.postMessage({
        type: 'alwaysAllowBrowser',
        bool: alwaysAllowBrowser,
      });
    ...
    >
      ...
      >
        ...
        <div style={{ marginBottom: 40 }}>
          ...
          >
            The following settings allow CoolCline to automatically perform
            operations without requiring approval. Enable these settings only if
            you fully trust the AI and understand the associated security risks.
          </p>
          ...
          <div style={{ marginBottom: 15 }}>
            ...
            >
              When enabled, CoolCline will automatically view directory contents
              and read files without requiring you to click the Approve button.
            </p>
          </div>
          ...
          <div style={{ marginBottom: 15 }}>
            ...
            {alwaysAllowWrite && (
              <div style={{ marginTop: 10 }}>
                ...
                >
                  Delay after writes to allow diagnostics to detect potential
                  problems
                </p>
              </div>
            )}
          ...
          <div style={{ marginBottom: 15 }}>
            ...
            >
              Automatically retry failed API requests when server returns an
              error response
            </p>
            {alwaysApproveResubmit && (
              <div style={{ marginTop: 10 }}>
                ...
                >
                  <input
                    ...
                    value={requestDelaySeconds}
                    onChange={(e) =>
                      setRequestDelaySeconds(parseInt(e.target.value))
                    }
                    style={{
                      flex: 1,
                      accentColor: 'var(--vscode-button-background)',
          ...
          <div style={{ marginBottom: 15 }}>
            ...
            >
              Automatically execute allowed terminal commands without requiring
              approval
            </p>
        ...
        <div style={{ marginBottom: 40 }}>
          ...
          <div style={{ marginBottom: 15 }}>
            ...
            >
              Select the viewport size for browser interactions. This affects
              how websites are displayed and interacted with.
            </p>
          </div>
          ...
          <div style={{ marginBottom: 15 }}>
            ...
            >
              Adjust the WebP quality of browser screenshots. Higher values
              provide clearer screenshots but increase token usage.
            </p>
          </div>
        </div>
        ...
        <div style={{ marginBottom: 40 }}>
          ...
          <div style={{ marginBottom: 15 }}>
            ...
            >
              When enabled, CoolCline will play sound effects for notifications
              and events.
            </p>
          </div>
          {soundEnabled && (
        ...
        <div style={{ marginBottom: 40 }}>
          ...
          <div style={{ marginBottom: 15 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
              ...
              <input
                ...
                value={terminalOutputLineLimit ?? 500}
                onChange={(e) =>
                  setTerminalOutputLineLimit(parseInt(e.target.value))
                }
                style={{
                  flexGrow: 1,
                  accentColor: 'var(--vscode-button-background)',
            ...
            >
              Maximum number of lines to include in terminal output when
              executing commands. When exceeded lines will be removed from the
              middle, saving tokens.
            </p>
          </div>
          ...
          <div style={{ marginBottom: 15 }}>
            ...
            >
              When enabled, CoolCline will be able to edit files more quickly
              and will automatically reject truncated full-file writes. Works
              best with the latest Claude 3.5 Sonnet model.
            </p>
              ...
              <div style={{ marginTop: 10 }}>
                ...
                >
                  ...
                  <VSCodeCheckbox
                    ...
                    onChange={(e: any) =>
                      setExperimentalDiffStrategy(e.target.checked)
                    }
                  >
                    <span style={{ fontWeight: '500' }}>
                ...
                >
                  Enable the experimental unified diff strategy. This strategy
                  might reduce the number of retries caused by model errors but
                  may cause unexpected behavior or incorrect edits. Only enable
                  if you understand the risks and are willing to carefully
                  review all changes.
                </p>
                ...
                >
                  This slider controls how precisely code sections must match
                  when applying diffs. Lower values allow more flexible matching
                  but increase the risk of incorrect replacements. Use values
                  below 100% with extreme caution.
                </p>
              </div>
            )}
          </div>
