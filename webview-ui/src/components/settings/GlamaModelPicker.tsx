...
const GlamaModelPicker: React.FC = () => {
  ...
  const [searchTerm, setSearchTerm] = useState(
    apiConfiguration?.glamaModelId || glamaDefaultModelId
  );
  ...
  useEffect(() => {
    if (
      ...
      apiConfiguration?.glamaModelId !== searchTerm
    ) {
      ...
      <div>
        ...
        <DropdownWrapper ref={dropdownRef}>
          <VSCodeTextField
            ...
            style={{
              width: '100%',
              zIndex: GLAMA_MODEL_PICKER_Z_INDEX,
              position: 'relative',
            }}
          >
            {searchTerm && (
