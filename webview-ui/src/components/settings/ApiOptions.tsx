...
const ApiOptions = ({
  ...
  const { apiConfiguration, uriScheme, handleInputChange } =
    useExtensionState();
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
      <div className="dropdown-container">
        <label htmlFor="api-provider">
          <span style={{ fontWeight: 500 }}>LLM Provider</span>
        </label>
        <Dropdown
          id="api-provider"
      ...
      {selectedProvider === 'bedrock' && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
          ...
          >
            ...
            AWS credential providers, i.e. ~/.aws/credentials or environment
        ...
        <div>
          ...
          >
            ...
            >
              ...
              >
                Configure the capabilities and pricing for your custom
                OpenAI-compatible model. <br />
                Be careful for the model capabilities, as they can affect how
                CoolCline can work.
              </p>
                  ...
                  <div className="token-config-field">
                    ...
                    >
                      ...
                      <span>
                        ...
                        This will help CoolCline Code run correctly.
                      </span>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    >
                      <div className="feature-toggle">
                        ...
                        >
                          Allows the model to analyze and understand images,
                          essential for visual code assistance
                        </p>
                      </div>
                      ...
                      >
                        ...
                        >
                          This model feature is for computer use like sonnet 3.5
                          support
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="price-input">
                    <VSCodeTextField
                      ...
                      style={{
                        ...
                        borderColor: (() => {
                          const value =
                            apiConfiguration?.openAiCustomModelInfo?.inputPrice;
                          if (!value && value !== 0)
          ...
          >
            <span style={{ color: 'var(--vscode-errorForeground)' }}>
              (<span style={{ fontWeight: 500 }}>Note:</span> CoolCline uses
      ...
      {selectedProvider === 'lmstudio' && (
        <div>
          ...
          >
            LM Studio allows you to run models locally on your computer. For
        ...
        <div>
          <div className="dropdown-container">
            ...
            {vsCodeLmModels.length > 0 ? (
              ...
              >
                The VS Code Language Model API allows you to run models provided
                by other VS Code extensions (including but not limited to GitHub
                Copilot). The easiest way to get started is to install the
                Copilot and Copilot Chat extensions from the VS Code
                Marketplace.
              </p>
            )}
            ...
            >
              Note: This is a very experimental integration and may not work as
              expected. Please report any issues to the CoolCline GitHub
              repository.
            </p>
          </div>
        </div>
  ...
  switch (provider) {
    ...
    case 'glama':
      return {
        ...
        selectedModelInfo:
          apiConfiguration?.glamaModelInfo || glamaDefaultModelInfo,
      };
    case 'mistral':
