...
const PromptsView = ({ onDone }: PromptsViewProps) => {
  ...
  const updateCustomMode = useCallback(
    (slug: string, modeConfig: ModeConfig) => {
      vscode.postMessage({
  ...
  const findModeBySlug = useCallback(
    (
      ...
      const isModeWithSlug = (mode: ModeConfig): mode is ModeConfig =>
        mode.slug === searchSlug;
  ...
  const [newModeCustomInstructions, setNewModeCustomInstructions] =
    useState('');
  const [newModeGroups, setNewModeGroups] =
    useState<readonly ToolGroup[]>(availableGroups);
  ...
  const handleEnhancePromptChange = (
    e: Event | React.FormEvent<HTMLElement>
  ): void => {
    const value =
    ...
    >
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '0 20px' }}>
        <div style={{ marginBottom: '20px' }}>
          ...
          >
            These instructions apply to all modes. They provide a base set of
            behaviors that can be enhanced by mode-specific instructions below.
          </div>
          <VSCodeTextArea
        ...
        <div style={{ marginBottom: '20px' }}>
            ...
            <div style={{ display: 'flex', gap: '8px' }}>
              ...
              <VSCodeButton
                ...
                onClick={() => {
                  vscode.postMessage({
                    type: 'openFile',
                    text: 'settings/coolcline_custom_modes.json',
                  });
                }}
              >
          ...
          >
            Hit the + to create a new custom mode, or just ask CoolCline in chat
        ...
        <div style={{ marginBottom: '20px' }}>
                ...
                >
                  {(() => {
                    ...
                    return enabledGroups
                      .map((group) => GROUP_DISPLAY_NAMES[group])
                      .join(', ');
                  })()}
                </div>
              )}
          ...
          <div style={{ marginBottom: '8px' }}>
            ...
            >
              Add behavioral guidelines specific to{' '}
              {getCurrentMode()?.name || 'Code'} mode.
            </div>
            <VSCodeTextArea
              value={(() => {
                const customMode = findModeBySlug(mode, customModes);
            ...
            >
              Custom instructions specific to {getCurrentMode()?.name || 'Code'}{' '}
              mode can also be loaded from{' '}
              <span
                style={{
                  color: 'var(--vscode-textLink-foreground)',
                  cursor: 'pointer',
        ...
        <h3
          style={{ color: 'var(--vscode-foreground)', margin: '40px 0 20px 0' }}
        >
          Prompt Enhancement
        </h3>
        ...
        >
          Use prompt enhancement to get tailored suggestions or improvements for
          your inputs. This ensures CoolCline understands your intent and
          provides the best possible responses.
        </div>
          ...
          <div>
            <div style={{ marginBottom: '12px' }}>
              <div style={{ marginBottom: '8px' }}>
                ...
                >
                  You can select an API configuration to always use for
                  enhancing prompts, or just use whatever is currently selected
                </div>
              </div>
              <VSCodeDropdown
            ...
            <div style={{ marginBottom: '8px' }}>
              ...
              >
                This prompt will be used to refine your input when you hit the
                sparkle icon in chat.
              </div>
            </div>
            <VSCodeTextArea
          ...
          >
            ...
            >
              ...
              <div style={{ marginBottom: '16px' }}>
                ...
                >
                  The slug is used in URLs and file names. It should be
                    ...
                    <VSCodeCheckbox
                      ...
                      onChange={(e: Event | React.FormEvent<HTMLElement>) => {
                        ...
                        if (checked) {
                          ...
                          setNewModeGroups(
                            newModeGroups.filter((g) => g !== group)
                          );
                        }
                      }}
                    >
